...
import models.TableModelArtikli;

/**
 *
 * @author PC
 */
public class FormPretragaArtikla extends javax.swing.JDialog {

    public FormPretragaArtikla(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        TableModelArtikli model = new TableModelArtikli();
        Thread th = new Thread(model);
        th.start();
        tblArtikli.setModel(model);
        setTitle("Pretraga artikla");
    }
    ...
    private void initComponents() {
        ...
        btnDetalji.setText("Detalji artikla");
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((TableModelArtikli) tblArtikli.getModel()).setParametar(param);
    }//GEN-LAST:event_txtPretragaKeyReleased

    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed

        int row = tblArtikli.getSelectedRow();

        if (row >= 0) {
            Artikal a = ((TableModelArtikli) tblArtikli.getModel()).getSelectedArtikal(row);
            new FormDetaljiArtikla(this, true, a).setVisible(true);
        }
    ...
    void refreshTable() {
        TableModelArtikli tm = (TableModelArtikli) tblArtikli.getModel();
        tm.refreshTable();
    }
